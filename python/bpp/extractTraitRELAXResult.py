...
def extract_traitrelax_parameters(input_path):
    ...
    regex_strings = {"null_logl": "\*\*\*\*\s*Null model fitting\s*\*\*\*\*.*?\*\*\s*Model parameters after sequence model optimizaiton\s*\*\*.*?Overall Log likelihood\.*\:\s*(-\d*\.?\d*)",
                     "null_kappa": "\*\*\*\*\s*Null model fitting\s*\*\*\*\*.*?\*\*\s*Model parameters after sequence model optimizaiton\s*\*\*.*?model 2.*?kappa\.*\:\s*(\d*\.?\d*)",
                     "null_p": "\*\*\*\*\s*Null model fitting\s*\*\*\*\*.*?\*\*\s*Model parameters after sequence model optimizaiton\s*\*\*.*?model 2.*?p\.*\:\s*(\d*\.?\d*)",
                     "null_omega1": "\*\*\*\*\s*Null model fitting\s*\*\*\*\*.*?\*\*\s*Model parameters after sequence model optimizaiton\s*\*\*.*?model 2.*?omega1\.*\:\s*(\d*\.?\d*)",
                     "null_omega2": "\*\*\*\*\s*Null model fitting\s*\*\*\*\*.*?\*\*\s*Model parameters after sequence model optimizaiton\s*\*\*.*?model 2.*?omega2\.*\:\s*(\d*\.?\d*)",
                     "null_theta1": "\*\*\*\*\s*Null model fitting\s*\*\*\*\*.*?\*\*\s*Model parameters after sequence model optimizaiton\s*\*\*.*?model 2.*?theta1\.*\:\s*(\d*\.?\d*)",
                     "null_theta2": "\*\*\*\*\s*Null model fitting\s*\*\*\*\*.*?\*\*\s*Model parameters after sequence model optimizaiton\s*\*\*.*?model 2.*?theta2\.*\:\s*(\d*\.?\d*)",
                     "null_k": "\*\*\*\*\s*Null model fitting\s*\*\*\*\*.*?\*\*\s*Model parameters after sequence model optimizaiton\s*\*\*.*?model 2.*?k\.*\:\s*(\d*\.?\d*)",
                     ...
                     "alternative_theta1": "\*\*\*\*\s*Alternative model likelihood after optimization\s*\*\*\*\*.*?\.theta1_1\.*\:\s*(\d*\.?\d*)",
                     "alternative_theta2": "\*\*\*\*\s*Alternative model likelihood after optimization\s*\*\*\*\*.*?\.theta2_1\.*\:\s*(\d*\.?\d*)",
