...
LoadFunctionLibrary("SelectionAnalyses/modules/custom_functions.bf");
...
function trait_relax.optimize_null_model() 
{
	...
	trait_relax.null_model.fit = custom_functions.FitLF_FixedBLs (trait_relax.filter_names, trait_relax.trees, None, { "0" : base_model_map}, 
																		...
																		{terms.run_options.proportional_branch_length_scaler: trait_relax.scaler, "optimize_branch_lengths": TRUE});
...
function trait_relax.optimize_by_true_history() {
	...
	trait_relax.latest_estimates = trait_relax.final_partitioned_mg_results[utility.getGlobalValue("terms.global")]; // ignore the output of the null fitting in order to avoid its local maxima
	trait_relax.set_codon_model();
	
	trait_relax.alternative_model.fit = custom_functions.FitLF_FixedBLs(joint_sequence_filter_names, joint_sequence_trees, lf_formula, model_maps, trait_relax.alternative_model.initial_parameters, trait_relax.model_object_map, {terms.run_options.proportional_branch_length_scaler: trait_relax.scaler, "custom_lf_formula": TRUE, "optimize_branch_lengths": TRUE});
...
{	
	...
	fprintf(alternative_fit_documentation_dir, "trait_relax.alternative_model.fit:\n", trait_relax.alternative_model.fit, "\n"); // debug
